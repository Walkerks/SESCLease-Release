...
#endif
	ops[OpKey(0xFC00003F,0xbc000000)]<<OpData( "lease"    , CtlNorm , TypNop   , ArgNo  , ArgNo  , ArgNo  , ImmNo  ,emulLease);
	printf("Leasing");
    ops[OpKey(0xFC00003F,0xbc000001)]<<OpData( "release"      , CtlNorm , TypNop   , ArgNo  , ArgNo  , ArgNo  , ImmNo  , emulRelease);
